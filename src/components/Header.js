...
export default function Header() {
    return (<header className="px-8 bg-white py-2 border-b">
        <nav className="flex items-center justify-between">
            ...
            <a href="#" title="" className="items-center justify-center hidden px-4 py-2 ml-6 text-sm font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md lg:inline-flex hover:bg-blue-700 focus:bg-blue-700" role="button"> Get started now </a>
        </nav>
